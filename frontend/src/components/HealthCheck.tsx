...
export default function HealthCheck() {
  ...
  const { data, loading, error, execute } = useApi(getSystemHealth, {
    immediate: true,
  });
        ...
        <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <div
                className={`text-sm font-semibold ${getStatusColor(data.database)}`}
              >
        ...
        <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <div
                className={`text-sm font-semibold ${getStatusColor(data.redis)}`}
              >
                {data.redis || 'unknown'}
              </div>
            </div>
