...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_attractions_park_id'), 'attractions', ['park_id'], unique=False)
    ...
    sa.Column('accessibility_needs', postgresql.ARRAY(sa.String(length=80)), nullable=False),
    sa.Column('dietary_restrictions', postgresql.ARRAY(sa.String(length=80)), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index(op.f('ix_chat_messages_itinerary_id'), 'chat_messages', ['itinerary_id'], unique=False)
    ...
    op.create_index(op.f('ix_itinerary_items_attraction_id'), 'itinerary_items', ['attraction_id'], unique=False)
    ...
    op.create_table('itinerary_parks',
    sa.Column('itinerary_id', sa.Integer(), nullable=False),
    sa.Column('park_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_itinerary_parks_itinerary_id'), 'itinerary_parks', ['itinerary_id'], unique=False)
    op.create_index(op.f('ix_itinerary_parks_park_id'), 'itinerary_parks', ['park_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_itinerary_items_attraction_id'), table_name='itinerary_items')
