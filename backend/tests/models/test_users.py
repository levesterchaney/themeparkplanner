...
class TestSession:
    ...
    def test_session_is_expired_none(self):
        """Test session expiration check when expires_at is None."""
        session = Session(
            user_id=1, token="test_token_123", expires_at=None  # Never expires
        )
