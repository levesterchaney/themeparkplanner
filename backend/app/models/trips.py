from sqlalchemy import Column, Integer, String, DateTime, Text, Boolean, JSON, ForeignKey, UniqueConstraint, PrimaryKeyConstraint
...
class Itinerary(Base):
    ...
    __table_args__ = (
        UniqueConstraint('trip_id', 'day_date', name='uix_trip_day'),
    )
